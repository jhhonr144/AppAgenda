...
public class MyAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Toast.makeText(context, "alarma trabajando", Toast.LENGTH_LONG).show();
    ...
    private void triggerNotification(Context contexto, String t) {
        ...
        builder.setContentIntent(contentIntent)
                ...
                .setContentText(t)
                .setContentInfo("Info")
                .setLargeIcon(BitmapFactory.decodeResource(contexto.getResources(), R.drawable.ic_add_alert_black_24dp))
